...
export default async (req: Request) => {
  ...
  if (!postalCode) return errorJson("Inserisci un CAP portoghese, es. 1000-001.");
  ...
  try {
    ...
    const message = err instanceof Error ? err.message : "Errore nel trovare i supermercati.";
